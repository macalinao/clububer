...
if (USERGOLD && GLD_AVATAR) {
	if (!$user_data['user_avatar']) {
		...
		echo "<td class='tbl'>";
		echo "Don't have an avatar?<br />";
		echo "Create one <a href='".INFUSIONS."ug_avatarmaker/'>here</a>.";
		echo "</td>";
		echo "</tr>\n";
	} else {
		echo "<tr>\n";
		...
		echo "<a href='".INFUSIONS."ug_avatarmaker/'>Change Avatar</a>";
	...
	echo "<td valign='top' class='tbl'>".$locale['u010'].":</td>\n";
	echo "<td class='tbl'>";
	echo "To get your own avatar, you must <a href='".INFUSIONS."user_gold/index.php?op=shop_start'>buy the privilege</a>.";
	echo "</td>";
	echo "</tr>\n";
}
