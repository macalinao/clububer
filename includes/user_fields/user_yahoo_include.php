...
if ($profile_method == "input") {
	...
	if ($user_data['user_yahoo']) {
		...
		echo "<td align='right' class='tbl1'>".$user_data['user_yahoo']."&nbsp;<img style='vertical-align:middle;border:none' src='http://www.IMStatusCheck.com/status/yahoo/".$user_data['user_yahoo']."' alt='".$user_data['user_yahoo']."' /></td>\n";
		echo "</tr>\n";
	}
