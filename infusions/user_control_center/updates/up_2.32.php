...
opentable("Update: v2.31 => v2.32");

//-----------

$res1 = dbquery("UPDATE ".$db_prefix."ucc_settings SET ucc_version = '2.32'");

$res2 = dbquery("UPDATE ".$db_prefix."infusions SET inf_version='2.32' WHERE inf_folder='user_control_center'");
