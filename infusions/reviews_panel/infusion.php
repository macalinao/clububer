...
$infusion = array(
	...
	'description'	=> 'Professional Review System',
	'version'	=> '1.8.4',
...
$new_tables['prp_cats'] = "(
	...
	cat_review_access tinyint(3) unsigned NOT NULL default '0',
	cat_order smallint(5) unsigned NOT NULL default '0',
	count_reviews int(10) unsigned NOT NULL default '0',
	PRIMARY KEY (cat_id)
) TYPE=MyISAM;";

$new_tables['prp_votes'] = "(
	review_id smallint(5) unsigned NOT NULL default '0',
	user_id smallint(5) unsigned NOT NULL default '0',
	vote_opt tinyint(1) unsigned NOT NULL default '0',
	PRIMARY KEY (review_id, user_id)
) TYPE=MyISAM;";

$new_tables['prp_comments'] = "(
...
$new_tables['prp_settings'] = "(
	...
	upload_image varchar(200) NOT NULL default 'infusions/reviews_panel/images/',
	image_max int(12) unsigned NOT NULL default '1048576',
	file_ext varchar(200) NOT NULL default 'zip,rar,tar,exe,tar.gz',
	upload_file varchar(200) NOT NULL default 'infusions/reviews_panel/reviews/',
	...
	review_restricted text NOT NULL,
...
$new_rows[] = "prp_settings
SET
id=1,
broken_text='".stripinput($locale['PRP143'])."',
